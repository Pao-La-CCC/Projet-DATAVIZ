...
const countryVariable = [ZAF1,AGO1,BEN1,BWA1,BFA1,BDI1,CPV1,CMR1,COM1,COD1,COG1,CIV1,ERI1,ETH1,GAB1,GAM1,GAN1,GIN1,GNQ1,GNB1,KEN1,LSO1,LBR1,MDG1,MWI1,MLI1,MUS1,MRT1,MOZ1,NAM1,NER1,NGA1,UGA1,CAF1,RWA1,STP1,SEN1,SYC1,SLE1,SOM1,SDN1,SSD1,TZA1,TCD1,TGO1,ZMB1,ZWE1,DZA1,DJI1,EGY1,WSR1,LBY1,MAR1,SWZ1,TUN1]

const countryInitials = ["ZAF1","AGO1","BEN1","BWA1","BFA1","BDI1","CPV1","CMR1","COM1","COD1","COG1","CIV1","ERI1","ETH1","GAB1","GAM1","GAN1","GIN1","GNQ1","GNB1","KEN1","LSO1","LBR1","MDG1","MWI1","MLI1","MUS1","MRT1","MOZ1","NAM1","NER1","NGA1","UGA1","CAF1","RWA1","STP1","SEN1","SYC1","SLE1","SOM1","SDN1","SSD1","TZA1","TCD1","TGO1","ZMB1","ZWE1","DZA1","DJI1","EGY1","WSR1","LBY1","MAR1","SWZ1","TUN1"]
...
function data(base) { 
    ...
    .then(function (data) { 
        ...
        const pibValue = document.querySelector('.pib-value') ;
        const accessElectricity= document.querySelector('.access-electricity') ;

        countryName.innerHTML = data[base]["Nom de Pays"]
        pibValue.innerHTML = data[base]["PIB/Habitant"]
        accessElectricity.innerHTML = data[base]["Taux d'électricité"]+ '%';
...
countryVariable.forEach((element,index) => {
    ...
    element.addEventListener('click', ()=>{
        ...
        tableau.classList.toggle('is-active');
        element.classList.add('blanc'); 

        console.log(countryInitials[index])
        data(countryInitials[index])
